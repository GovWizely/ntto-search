...
const config = Object.assign({
  development: {
    api: {
      i94_url: 'http://api.trade.gov/v1/i94_monthly_data/search',
      i92_url: 'http://api.trade.gov/v1/i92_entries/search',
      spending_data_url: 'http://api.trade.gov/v1/ntto_spending_data/search',
      siat_url: 'http://api.trade.gov/v1/siat_data/search',
